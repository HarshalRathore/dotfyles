...
- **Benchmark QED** — a new benchmark that went open source alongside the talk, with a blog post scheduled for the following day ^[extracted]
- **LazyGraphRAG** — an evolution of GraphRAG with improved benchmark performance, to be released soon. Larson did not disclose the specific mechanics in his talk, focusing instead on benchmark results ^[extracted]
