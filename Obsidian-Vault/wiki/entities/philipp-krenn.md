...
Developer advocate and search expert at [[entities/elastic]], presenting at AI Engineer World's Fair 2025 on information retrieval fundamentals.

## Background

- Works at Elastic, the company behind Elasticsearch — the most downloaded/deployed search engine ^[extracted]
- Native German speaker, uses this to demonstrate language-specific analysis pipeline behavior ^[extracted]
- Demo-driven presenter: all concepts shown via live Elasticsearch queries on a shared workshop instance ^[extracted]

## Contributions

- Delivered "Information Retrieval from the Ground Up" workshop at AI Engineer World's Fair 2025 ^[extracted]
