...
summary: Sarah Sachs (Notion AI lead) and Carlos Esteban (Braintrust) discuss how Notion builds world-class AI products through evaluation-driven development, per-element LLM-as-judge, curated datasets, and...
provenance:
  extracted: 0.75
  inferred: 0.2
  ambiguous: 0.05
