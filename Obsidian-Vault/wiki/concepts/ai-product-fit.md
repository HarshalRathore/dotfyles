...
summary: The principle that just because an AI model exists and works doesn't mean it should be integrated into a product. Product fit requires alignment with actual user behavior, not just technical capability.
...
[[Christopher Chedeau|christopher-chedeau]] articulated this lesson at AIEF2025 after his team experimented with AI integrations for [[Excalidraw|excalidraw]]. The cautionary example was a model built by [[File AI|file-ai]] that could transform Excalidraw diagrams with natural elements (palm trees, sun) into photorealistic beach scenes. The model worked well — Chedeau called it "mind-blowing" — but people don't draw realistic images on Excalidraw. They draw diagrams.
