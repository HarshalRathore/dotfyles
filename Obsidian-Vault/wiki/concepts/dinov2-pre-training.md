...
summary: DINOv2 is a self-supervised vision model trained on internet-scale data that discovers rich, discriminative visual features including object boundaries, body segments, and cross-species analogies —...
sources:
