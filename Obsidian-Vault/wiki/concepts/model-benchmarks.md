...
- gemini
- model-development
summary: Standardized evaluation metrics used to measure and compare AI model performance across reasoning, coding, math, and other capabilities. Benchmarks function as memes that shape AI development throu...
provenance:
  extracted: 0.6
  inferred: 0.3
  ambiguous: 0.1
