...
summary: Learned sparse retrieval (ELSER/SPLADE) represents text as a list of expanded terms with relevance weights. More interpretable than dense vectors but expensive at query time due to many OR-style ma...
provenance:
  extracted: 0.85
  inferred: 0.1
  ambiguous: 0.05
